...
// Convert the rl.question method to a version that returns a promise
...
const fillLoginInput = async () => {
  ...
  const formControls = await driver.findElements(By.className("form-control"));
